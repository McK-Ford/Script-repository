...
CpG_start_TSS = arrange(CpG_start_TSS, desc(end-start))
...
m_TCE_NI = lapply(bam_list, get_score_matrix, bed=TSS_CpG_end, b=-1000, a=1000,
...
m_TCE_NI2 <- lapply(m_TCE_NI, data.table::melt, measure.vars=c(2:201),
...
merged_mat=cbind(m_TCE_NI2[[1]], m_TCE_NI2[[2]][[3]], m_TCE_NI2[[3]][[3]],
                 m_CST_NI2[[1]][[3]], m_CST_NI2[[2]][[3]], m_CST_NI2[[3]][[3]],
                 m_TCE_I2[[1]][[3]], m_TCE_I2[[2]][[3]], m_TCE_I2[[3]][[3]],
                 m_CST_I2[[1]][[3]], m_CST_I2[[2]][[3]], m_CST_I2[[3]][[3]])
colnames(merged_mat)=c("gene_ID", "Bins", "TCE_NI_H3K4me3", "TCE_NI_H2AZ",
                       "TCE_NI_KDM5B", "CST_NI_H3K4me3", "CST_NI_H2AZ",
                       "CST_NI_KDM5B", "TCE_I_H3K4me3", "TCE_I_H2AZ",
                       "TCE_I_KDM5B", "CST_I_H3K4me3", "CST_I_H2AZ",
                       "CST_I_KDM5B"
)
...
#I see what I did. I effed up the CpG start TSS end choice of anchor, can sort the TSS-CpG end one by the CpG start TSS end order.
...
save(m_CST_NI, m_TCE_I, m_TCE_NI, file="mats.RData")
load("mats.RData")
...
mm2 = m_CST_NI2[[1]][,c(1,2)]
mm2$Bins=as.numeric(mm2$Bins)
mm3 = merge(mm2, mm1, sort=FALSE)

colnames(mm3)=c("gene_ID", "Bins", "NI_H3K4me3", "NI_H2AZ",
                       "NI_KDM5B", "I_H3K4me3", "I_H2AZ",
                       "I_KDM5B")

mm3$Bins = as.numeric(as.character(mm3$Bins))*10-1000
mytheme = theme(
  panel.background=element_rect(fill="white"),
  text=element_text(color="black",face="bold",family="sans"),
  axis.text=element_text(color="black"),
...
pdf(file="test_CpG_start_TSS.pdf", width = 3.5)
