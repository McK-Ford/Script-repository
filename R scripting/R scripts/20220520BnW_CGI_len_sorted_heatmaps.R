...
mm2$Bins = as.numeric(as.character(mm2$Bins))*10-1000
...
ggplot(data=mm2, mapping=aes(
   ...
   scale_fill_gradient(name="H3K4me3", low = "#FFFFFF",
                      high = "#000000", oob=scales::squish, limits=c(0,16)) +
...
ggplot(data=mm2, mapping=aes(
  ...
  scale_fill_gradient(name="H2AZ", low = "#FFFFFF",
                      high = "#000000", oob=scales::squish, limits=c(0,3)) +
  theme(axis.text.y = element_blank())
dev.off()
...
ggplot(data=mm2, mapping=aes(
  ...
  scale_fill_gradient(name="KDM5B", low = "#FFFFFF",
                      high = "#000000", oob=scales::squish, limits=c(0,2.4)) +
  theme(axis.text.y = element_blank())
dev.off()
...
ggplot(data=mm3, mapping=aes(
  ...
  theme(axis.text = element_blank()) + xlim(0,1000)
dev.off()
